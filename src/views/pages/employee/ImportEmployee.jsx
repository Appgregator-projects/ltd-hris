...
import TemplateExcel from './component/TemplateExcel'
...
const ImportEmployee = () => {
     ...
     const handleImport = async () => {
          const nyong = await Api.post('/auth/bulk-users',tableData)
          console.log(nyong,"inyong")
          // MySwal.fire({
          //      title: "Are you sure?",
          //      text: `Set Tax for ${taxType}?`,
          //      icon: "warning",
          ...
          //           // const { status, data } = await Api.post("/hris/migration-payroll", { type: taxType, data: tableData })
          //           const status = ""
          //           const data= ""
          ...
          //                     icon: "success",
          //                     title: "Success!",
          //                     text: `Employee has been imported!`,
          //                     customClass: {
     ...
     return (
          <Fragment>
               <Breadcrumbs
                    ...
                    data={[{ title: "User", link: '/employee' }, { title: "Import Employee"}]}
                    rightMenu={<TemplateExcel clicks={clicks} setClicks={setClicks}/>}
               />
               ...
               <Row className='import-component'>
                    <Col sm='12'>
                         <Card>
                              {/* <CardHeader>
                                   <Col md={3}>
                                        <Label>Peraturan Pajak</Label>
                                        <Input type='select' onChange={(e) => setTaxType(e.target.value)}>
                                             <option value=''>Select Tax</option>
                                             <option value={'teh'}>Tarif Efektif Harian</option>
                                             <option value={'ter'}>Tarif Efektif Rata-rata</option>
                                             <option value={'pasal17'}>Pasal 17</option>
                                             <option value={'ptkp'}>Penghasilan Tidak Kena Pajak (PTKP)</option>
                                        </Input>
                                   </Col>
                              </CardHeader> */}
                              <CardBody>
