			...
			<Row className="mb-1">
					...
					<Card>
						<CardBody>
							<Avatar
								...
								icon={<User />}
							/>
							<h2 className="fw-bolder mt-1">16/20</h2>
							<p className="card-text">Total Submitted</p>
						</CardBody>
						{/* <Chart
							options={options}
							series={series}
					...
					<Card>
						<CardBody>
							<Avatar
								...
								icon={<Check />}
							/>
							<h2 className="fw-bolder mt-1">8/16</h2>
				...
				<Col>
					{paginatedData?.map((item, index) => (
						<Card key={index} className="p-1 my-1">
