      ...
      >
        ...
        <ModalBody className="px-sm-5 mx-50 pb-5">
          <div className="text-center mb-2">
            <h1 className="mb-1">Create New Course</h1>
            <p>
              Add a course to your platform. Provide the title, description,
              author, and other details. Click 'Submit' to save the course and
